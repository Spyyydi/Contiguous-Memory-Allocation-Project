/** \file    project.c
 *  \brief   Managing a contiguous region of memory
 *  \details Contiguous memeory allocation:
...
struct Node *temp;           //pointer used to traverse throught contiguous memory

int last_address_space;      //to keep track of not going beyond the given memory space
